    ...
    public  void goStyle(){
        ...
        if(est !=null){
            if(est.equalsIgnoreCase("1")){
                ...
                user_txt.setTypeface(EasyFonts.droidSerifBoldItalic(this));
                ...
                user_txt.setTypeface(EasyFonts.caviarDreams(this));
                ...
                user_txt.setTypeface(EasyFonts.robotoBlackItalic(this));
            }
        }else{
